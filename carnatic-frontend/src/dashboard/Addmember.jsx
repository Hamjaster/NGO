...
export default function Addmember({ isOpen, onClose, setCount }) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(`${proxy}/dashboard/members`, formData);
                        ...
                        <div className="mx-5 mt-5 font-roboto">
                            ...
                            <div className={`w-full`}>
                                ...
                                <form onSubmit={handleSubmit} className="max-w-md mx-auto mt-8 bg-white rounded">
                                    ...
                                    <div className="mb-4">
                                        <label className="block text-gray-700 mb-2">Donation:</label>
                                        <input
                                            type="number"
                                            name="donation"
